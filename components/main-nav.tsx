    ...
    return (
        <NavigationMenu className="hidden md:block">
            <NavigationMenuList className="gap-6">
                ...
                <NavigationMenuItem>
                    <NavigationMenuTrigger className={cn("rounded-none", path.includes("ai-portfolio-manager") ? "border-b-2 border-b-black" : "")}>AI Portfilio Manager</NavigationMenuTrigger>
                    <NavigationMenuContent>
