...
export const PortfolioFormSchema = z.object({
    ...
    lockPeriod: z.enum(["90 days", "180 days", "365 days"], {
    ...
    return (
        <div className="rounded-2xl w-xl bg-[url('/blue-bg.jpeg')] bg-bottom-right">
            <div className="px-6 py-3">
                <div className="text-accent text-md font-medium">Please complete this form to create your portfolio</div>
            </div>
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel className="flex items-center gap-1.5 text-[#363F72]">
                                        ...
                                        <p className="text-sm font-medium">Risk Profile (Max Drawdown)</p>
                                    </FormLabel>
                                    ...
                                    <FormControl className="w-full">
                                        <Select onValueChange={field.onChange} defaultValue={field.value}>
                                            ...
                                            <SelectContent>
                                                ...
                                                <SelectItem value="Moderate">10-20% (Moderate)</SelectItem>
                        ...
                        <div className="space-y-2">
                            <Button className="w-full bg-[#363F72] rounded-4xl" type="submit">Generate Portfolio Strategy</Button>
                            <p className="text-[#717BBC] text-sm">Your preferences will be used to create an AI-generated portfolio optimized for current market conditions.</p>
                        </div>
                    </form>
                </Form>
            </div>
